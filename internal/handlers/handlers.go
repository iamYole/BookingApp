...
import (
	...
	"github.com/iamYole/BookingApp/internal/forms"
	...
	"github.com/iamYole/BookingApp/internal/repository/dbrepo"
)
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	rooms, err := m.DB.SearchAvailablityForAllRooms(start_date, end_date)
	if err != nil {
		helpers.ServerError(w, err)
	}

	if len(rooms) == 0 {
		m.App.Session.Put(r.Context(), "errpr", "No Availability")
